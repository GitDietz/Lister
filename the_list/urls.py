...
urlpatterns = [
    ...
    re_path('groups/make_leader/(?P<pk>\d+)(?P<user_id>\d+)', group_make_leader, name='group_make_leader'),
    re_path('groups/add_member/(?P<pk>\d+)(?P<user_id>\d+)', group_add_member, name='group_add_member'),
    re_path('groups/remove_self/(?P<pk>\d+)', group_remove_self, name='group_remove_self'),
    re_path('groups/remove_leader/(?P<pk>\d+)(?P<user_id>\d+)', group_remove_leader, name='group_remove_leader'),
    re_path('groups/remove_member/(?P<pk>\d+)(?P<user_id>\d+)', group_remove_member, name='group_remove_member'),
